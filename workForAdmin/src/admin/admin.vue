...
<div id="adminBox">
    ...
    <keep-alive>
    <component :is='manageUser' v-show="nav_show[0]" :nav_show="nav_show" @nav_choose="nav_choose"></component>
    </keep-alive>
    <keep-alive>
        <component :is='manageJob' v-show="nav_show[1]" @nav_choose="nav_choose"></component>    
    </keep-alive>
    <keep-alive>
